...
class FullAeroModel {
public:
    explicit FullAeroModel(RocketAeroInput<metricType> * aero_input, ComponentInterpolationManager<metricType> * interp_mgr)
...
private:
    RocketAeroInput<metricType> * aero_input_;
    ComponentInterpolationManager<metricType> * interp_mgr_;
